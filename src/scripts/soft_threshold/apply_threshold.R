...
parser$add_argument('--input', type="character", 
                   default="results/network_features/soft_threshold/unsigned_adjacency_matrix.csv",
...
if (!is.null(args$input) && args$input != "results/network_features/soft_threshold/unsigned_adjacency_matrix.csv") {
    ...
    soft_threshold_file <- file.path(soft_threshold_dir, "soft_threshold/unsigned_adjacency_matrix.csv")
...
output_file <- file.path(output_dir, "soft_threshold/soft_thresholded_adjacency_matrix.csv")
