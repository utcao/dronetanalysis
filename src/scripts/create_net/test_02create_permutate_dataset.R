...
#'   output files.
#' @param obs_col_pattern Character string or regular expression pattern to 
...
#'   \item{obs_col_pattern}{One or more columns with observed coexpression values}
...
#'   \item Only columns matching `obs_col_pattern` are kept in final output
